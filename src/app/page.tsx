...
export default function Home() {
  ...
  return (
    <>
      ...
      <section id="about" data-observe className="scroll-mt-[98px] flex flex-col justify-center items-center w-screen pb-5 px-4">
      ...
      <section id="projects" data-observe className="scroll-mt-[80px] flex flex-col justify-center items-center w-screen py-7 px-4">
        <div className="grid max-w-6xl md:grid-cols-2 gap-3">
          <div className="group bg-black/20 hover:bg-[#2A9D8F]/30 p-4 rounded-lg flex flex-col sm:flex-row-reverse gap-2 transition-all duration-200"
          ...
          <a target='_blank' href="https://note-bud.vercel.app/"
            className="group bg-black/20 hover:bg-[#2A9D8F]/30 cursor-pointer p-4 rounded-lg flex flex-col sm:flex-row-reverse gap-2 transition-all duration-200"
          ...
          >
            <div>
              ...
              <p className="leading-tight text-[#FFFFF0]">NoteBud is a NextJS web app with Convex backend; developed for managing documents and notes with loads of features (spoiler: includes 2 AI features)</p>
              <div className="flex flex-wrap gap-1.5 mt-1">
          ...
          >
            <div>
              ...
              <p className="leading-tight text-[#FFFFF0]">My portfolio website (where you are reading this from!) where is experimented and expanded my creativity in different technologies I have intersets in</p>
              <div className="flex flex-wrap gap-1.5 mt-1">
                <p className="text-[#80FFDB] bg-[#2A9D8F]/40 py-1 px-2 text-sm font-medium rounded-md w-fit">NextJS</p>
                <p className="text-[#80FFDB] bg-[#2A9D8F]/40 py-1 px-2 text-sm font-medium rounded-md w-fit">ReactJS</p>
                <p className="text-[#80FFDB] bg-[#2A9D8F]/40 py-1 px-2 text-sm font-medium rounded-md w-fit">TypeScript</p>
