...
export default function Home() {
  ...
  return (
    <>
      ...
      <section id="about" data-observe className="scroll-mt-[98px] smH:mt-32 xsH:mt-52 flex flex-col justify-center items-center w-screen pb-5 px-4">
      ...
      <section id="projects" data-observe className="scroll-mt-[80px] flex flex-col justify-center items-center w-screen py-7 md:mt-20 px-4">
